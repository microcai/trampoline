...
int main()
{
    ...
    auto test_cb = trampoline::c_function_ptr<callback_function_t>([=](int arg1, void* arg2, float arg3)
    {
        ...
        auto test_cb2 = new trampoline::c_function_ptr<callback_function_t>([=](auto this_cb, int arg1, void* arg2, float arg3)
        {
        ...
        return test_once_callback(*test_cb2);
    });

    return test_multi_callback(test_cb);
}
